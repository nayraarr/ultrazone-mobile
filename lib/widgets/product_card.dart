...
import 'package:ultrazone/screens/products_list_with_filter.dart';
...
class ItemCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Material(
      // Menentukan warna latar belakang dari item home page nya.
      color: item.color,
        ...
        onTap: () async {
          ...
          if (item.name == "Create Product") {
            ...
            Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => const ProductsListWithFilterPage()
              ),
            );
          } else if (item.name == "My Product") {
            // Navigate ke halaman filter dengan filter "My Product"
            Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => const ProductsListWithFilterPage(
                    initialFilter: 'my', // Pass parameter untuk filter "My Product"
                  )
              ),
            );
